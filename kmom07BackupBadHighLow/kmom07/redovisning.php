...
<div id="main-content">   
    ...
    <h1>Kursmoment 07</h1> 
        <h2>Äventyrsspel med PHP och databas</h2>
        
        <p>
            Jag gjorde spelmotorn enligt mallen. Skapade nya banor med hjälp av Inkscape och 
            openclipart. Den här gången lärde jag mig programmet bättre och det fungerar kanon då 
            det är enkelt att importera bilder och förminska och förstora dem som du vill.
            Hittade ett klipp som behandlade just grafik för webben 
            <a href='http://www.youtube.com/watch?v=P2Yj-8zGa3U' target='_blank'>Journey Through 
            the Graphical Web </a>. Det finns mycket finesser som du kan göra när du jobbar medm SVG
            filer. Jag tycker javascript och css styrning av layouten verkar häftigt det ska jag 
            kolla vidare på.
        <p>
        <p> I början kändes det tungt med bildhanteringen men när jag väl lärde mig funktionerna i Inkscape och lärde mig hitta bilder på openclipart sidan så gick det bra. Efter det så började jag fixa tabellerna i databasen  så att det fungerade i mitt spel. När jag skulle lägga över filerna till servern fick jag spara om SVG filerna i Inscape till plain SVG, då fungerade de bättre på skolservern. Filerna blev dessutom mindre i storlek så det var bra. Hade även problem med mellanslagen i php taggarna i början och i slutet av filerna. Allt fungerade lokalt men när jag lade upp de på skolservern fick jag errors som jag fick fixa till. Att köra två frågor i en SQL-sats var nytt för mig så det var bra att få prova på. Jag designade om layouten så att jag fick den design jag ville ha. Jag blev till slut nöjd med spelet som jag nu ser fram emot att få vidareutveckla.
        </p> 
        <p>
            <h2>Svar på frågorna</h2>    
            <h3> Följde du anvisningarna eller kodade du själv?</h3>
            <p>
             Började följa anvisningarna för att få koll på spelmotorn sedan lade jag till
             egen kod när det behövdes.
            </p>
            <h3>Känner du att du har lärt dig något om databaser och objektorienterad 
            PHP-programmering?</h3>
            <p>
            Jag tycker jag fått en bra bild på hur jag ska jobba i PHP med klasser och databaser. </p>
       
            <h3>Saknar du något?</h3>
        <p>
            Svår fråga det finns ju så otroligt mycket att jobba med så det är svårt att säga.
            Jag tycker det vi lärt oss är väldigt användbart både för mig själv och i mitt arbete. 
        </p>
            <h3>Är detta något du kommer ha nytta av framöver?</h3>
         <p> 
            Bra att få lära sig skapa en databas till ett spel samt att hantera SVG grafik. Dessa 
            saker kommer jag med all säkerhet att få andvändning av i framtiden. Jag tror att det 
            SVG kommer att utvecklas ännu mera framöver, då vi har så många olika skärmupplösningar
            att jobba mot.
        </p>
    ...
    <h1>Kursmoment 06</h1> 
        ...
        <p>
         ...
         <p>
            En sak som tog lite tid att fixa var inloggning till skolans PHPMyAdmin, men som tur 
            var hade jag gjort det en gång förut så det löste sig. Men det är en hel del fixande
            med lösen mm innan allt fungerar. Väl inloggad så fungerar PHPMyAdmin bra. Jag har
            jobbat i det tidigare så jag känner mig trygg i den miljön. Jag jobbar hellre i det 
            gränssnittet än i konsolmiljön.            
        </p>   
        <p>
            Nya kunskaper som att koppla databasen med mysqli och samt att definera globala 
            konstanter med hjälp av define() var bra att lära sig. Att jobba mot vyer var också
            lärorikt.       
        </p>        
        <p>
            Jag har jobbat med databaser förut men mest med Access men på senare tid har MySql
            tagit över. Jag tycker att SQL-språket är det enklaste dataspråket du kan jobba med. 
            Det är däremot mer problematiskt att bygga upp en databas med rätt relationer och 
            data.
        </p>
        <p>
    ...
    <h1>Kursmoment 05</h1> 
        ...
        <p>
            ...
            att få High och Low att endast visa två kort vid spel det skulle kännas mer
            realistiskt. Att kunna spela med en insats av något slag samt en highscorelista med  
