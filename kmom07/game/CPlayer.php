    ...
    public function SetCurrentRoomAndDecreaseHealtMeter($aId) {
        ...
        if($aId != $this->iLastRoomVisited) {
            ...
            if($this->iHealthMeter <= 0) {
                header('Location: http://www.student.bth.se/~mos/oophp/mom07/adventure08/gameover.php?reason=Hälsomätaren nådde 0');
            }
        }
    }
    ...
    public function PerformActionEvent($aActionEvent) {
        ...
        switch($aActionEvent) {
            ...
            case 'playGameHighLow': {
                header('Location: http://www.student.bth.se/~mos/oophp/mom07/adventure08/highlow/highlow.php?game=init');
            }
            break;
