...
(4, 'Grotta', 'Du är mitt i den djupa grottan. Du ser inte särskilt bra. Endast ett svagt ljussken lyser bakom dig från en gammal oljelampa. Det är bäst att sticka innan något hemskt händer.', '<embed type="image/svg+xml" src="img/cave.svg" width="707" height="480" />'),
...
(11, 8, 7, 'Stranden'),
(12, 8, 9, 'Spelstigen'),
(13, 9, 8, 'Hemliga staden'),
(14, 9, 6, 'Djupa skogen'),
(15, 6, 10, 'Borgen'),
(17, 10, 6, 'Djupa skogen'),
(19, 5, 8, 'Hemliga staden'),
(20, 2, 5, 'Höger'),
(22, 2, 1, 'Tillbaka'),
